...
# Code follows:
var.registers(['bt64ToHex', 'finallyPermute', 'xor', 'getKeyBytes', 'enc', 'initPermute', 'pPermute', 'byteToString', 'hexToBt4', 'sBoxPermute', 'strEnc', 'strToBt', 'expandPermute', 'bt4ToHex', 'dec', 'hexToBt64', 'generateKeys', 'getBoxBinary', 'strDec'])
@Js
def PyJsHoisted_strEnc_(data, firstKey, secondKey, thirdKey, this, arguments, var=var):
    var = Scope({'data':data, 'firstKey':firstKey, 'secondKey':secondKey, 'thirdKey':thirdKey, 'this':this, 'arguments':arguments}, var)
    var.registers(['tempBt', 'secondLength', 'thirdKey', 'tempData', 'thirdKeyBt', 'y', 'firstKeyBt', 'bt', 'iterator', 'firstKey', 'leng', 'encData', 'data', 'remainder', 'x', 'thirdLength', 'secondKeyBt', 'z', 'tempByte', 'i', 'remainderData', 'secondKey', 'firstLength', 'encByte'])
    ...
    if (var.get('leng')>Js(0.0)):
        if (var.get('leng')<Js(4.0)):
            ...
            pass
            if ((((((var.get('firstKey')!=var.get(u"null")) and (var.get('firstKey')!=Js(''))) and (var.get('secondKey')!=var.get(u"null"))) and (var.get('secondKey')!=Js(''))) and (var.get('thirdKey')!=var.get(u"null"))) and (var.get('thirdKey')!=Js(''))):
                pass
                pass
                ...
                if ((((var.get('firstKey')!=var.get(u"null")) and (var.get('firstKey')!=Js(''))) and (var.get('secondKey')!=var.get(u"null"))) and (var.get('secondKey')!=Js(''))):
                    pass
                    pass
                    var.put('tempBt', var.get('bt'))
                    #for JS loop
            ...
            while (var.get('i')<var.get('iterator')):
                try:
                    var.put('tempData', var.get('data').callprop('substring', ((var.get('i')*Js(4.0))+Js(0.0)), ((var.get('i')*Js(4.0))+Js(4.0))))
            ...
            if (var.get('remainder')>Js(0.0)):
                var.put('remainderData', var.get('data').callprop('substring', ((var.get('iterator')*Js(4.0))+Js(0.0)), var.get('leng')))
...
def PyJsHoisted_strDec_(data, firstKey, secondKey, thirdKey, this, arguments, var=var):
    var = Scope({'data':data, 'firstKey':firstKey, 'secondKey':secondKey, 'thirdKey':thirdKey, 'this':this, 'arguments':arguments}, var)
    var.registers(['tempBt', 'secondLength', 'thirdKey', 'tempData', 'thirdKeyBt', 'intByte', 'y', 'firstKeyBt', 'decStr', 'iterator', 'firstKey', 'leng', 'decByte', 'data', 'j', 'x', 'thirdLength', 'secondKeyBt', 'z', 'i', 'strByte', 'secondKey', 'firstLength'])
    var.put('leng', var.get('data').get('length'))
    var.put('decStr', Js(''))
    pass
    if ((var.get('firstKey')!=var.get(u"null")) and (var.get('firstKey')!=Js(''))):
    ...
    while (var.get('i')<var.get('iterator')):
        try:
            var.put('tempData', var.get('data').callprop('substring', ((var.get('i')*Js(16.0))+Js(0.0)), ((var.get('i')*Js(16.0))+Js(16.0))))
            ...
            while (var.get('j')<Js(64.0)):
                try:
                    var.get('intByte').put(var.get('j'), var.get('parseInt')(var.get('strByte').callprop('substring', var.get('j'), (var.get('j')+Js(1.0)))))
                finally:
...
def PyJsHoisted_getKeyBytes_(key, this, arguments, var=var):
    ...
    var.registers(['key', 'i', 'leng', 'keyBytes', 'iterator', 'remainder'])
    ...
    while (var.get('i')<var.get('iterator')):
        try:
            var.get('keyBytes').put(var.get('i'), var.get('strToBt')(var.get('key').callprop('substring', ((var.get('i')*Js(4.0))+Js(0.0)), ((var.get('i')*Js(4.0))+Js(4.0)))))
        finally:
                (var.put('i',Js(var.get('i').to_number())+Js(1))-Js(1))
    if (var.get('remainder')>Js(0.0)):
        var.get('keyBytes').put(var.get('i'), var.get('strToBt')(var.get('key').callprop('substring', ((var.get('i')*Js(4.0))+Js(0.0)), var.get('leng'))))
...
def PyJsHoisted_strToBt_(str, this, arguments, var=var):
    ...
    var.registers(['pow', 'j', 'k', 'i', 'bt', 'p', 'q', 'm', 'str', 'leng'])
            ...
            try:
                ...
                while (var.get('j')<Js(16.0)):
                    try:
                        ...
                        var.get('bt').put(((Js(16.0)*var.get('i'))+var.get('j')), (var.get('parseInt')((var.get('k')/var.get('pow')))%Js(2.0)))
                    finally:
                            (var.put('j',Js(var.get('j').to_number())+Js(1))-Js(1))
            finally:
                    (var.put('i',Js(var.get('i').to_number())+Js(1))-Js(1))
                        ...
                        while (var.get('m')>var.get('q')):
                            try:
                                var.put('pow', Js(2.0), '*')
                                    ...
                                    (var.put('m',Js(var.get('m').to_number())-Js(1))+Js(1))
                        var.get('bt').put(((Js(16.0)*var.get('p'))+var.get('q')), (var.get('parseInt')((var.get('k')/var.get('pow')))%Js(2.0)))
                    finally:
...
def PyJsHoisted_byteToString_(byteData, this, arguments, var=var):
    ...
    var.registers(['pow', 'byteData', 'count', 'str'])
    var.put('str', Js(''))
    #for JS loop
    var.put('i', Js(0.0))
    while (var.get('i')<Js(4.0)):
...
def PyJsHoisted_hexToBt64_(hex, this, arguments, var=var):
    ...
    while (var.get('i')<Js(16.0)):
        try:
            var.put('binary', var.get('hexToBt4')(var.get('hex').callprop('substring', var.get('i'), (var.get('i')+Js(1.0)))), '+')
        finally:
                (var.put('i',Js(var.get('i').to_number())+Js(1))-Js(1))
    return var.get('binary')
...
def PyJsHoisted_enc_(dataByte, keyByte, this, arguments, var=var):
    ...
    var.registers(['keys', 'tempRight', 'key', 'j', 'finalData', 'k', 'i', 'dataByte', 'ipByte', 'keyByte', 'm', 'n', 'ipLeft', 'ipRight', 'tempLeft'])
            ...
            while (var.get('m')<Js(48.0)):
                try:
                    var.get('key').put(var.get('m'), var.get('keys').get(var.get('i')).get(var.get('m')))
                        ...
                        (var.put('m',Js(var.get('m').to_number())+Js(1))-Js(1))
            var.put('tempRight', var.get('xor')(var.get('pPermute')(var.get('sBoxPermute')(var.get('xor')(var.get('expandPermute')(var.get('ipRight')), var.get('key')))), var.get('tempLeft')))
            #for JS loop
            var.put('n', Js(0.0))
    ...
    while (var.get('i')<Js(4.0)):
        try:
            ...
            while (var.get('j')>=Js(0.0)):
                try:
                    var.get('ipByte').put(((var.get('i')*Js(8.0))+var.get('k')), var.get('originalData').get(((var.get('j')*Js(8.0))+var.get('m'))))
                    var.get('ipByte').put((((var.get('i')*Js(8.0))+var.get('k'))+Js(32.0)), var.get('originalData').get(((var.get('j')*Js(8.0))+var.get('n'))))
                finally:
                        PyJsComma((var.put('j',Js(var.get('j').to_number())-Js(1))+Js(1)),(var.put('k',Js(var.get('k').to_number())+Js(1))-Js(1)))
        finally:
                PyJsComma(PyJsComma((var.put('i',Js(var.get('i').to_number())+Js(1))-Js(1)),var.put('m', Js(2.0), '+')),var.put('n', Js(2.0), '+'))
    ...
    while (var.get('i')<Js(8.0)):
        try:
            if (var.get('i')==Js(0.0)):
                ...
                var.get('epByte').put(((var.get('i')*Js(6.0))+Js(0.0)), var.get('rightData').get(((var.get('i')*Js(4.0))-Js(1.0))))
            var.get('epByte').put(((var.get('i')*Js(6.0))+Js(1.0)), var.get('rightData').get(((var.get('i')*Js(4.0))+Js(0.0))))
            var.get('epByte').put(((var.get('i')*Js(6.0))+Js(2.0)), var.get('rightData').get(((var.get('i')*Js(4.0))+Js(1.0))))
            var.get('epByte').put(((var.get('i')*Js(6.0))+Js(3.0)), var.get('rightData').get(((var.get('i')*Js(4.0))+Js(2.0))))
            var.get('epByte').put(((var.get('i')*Js(6.0))+Js(4.0)), var.get('rightData').get(((var.get('i')*Js(4.0))+Js(3.0))))
            if (var.get('i')==Js(7.0)):
                var.get('epByte').put(((var.get('i')*Js(6.0))+Js(5.0)), var.get('rightData').get('0'))
            else:
                var.get('epByte').put(((var.get('i')*Js(6.0))+Js(5.0)), var.get('rightData').get(((var.get('i')*Js(4.0))+Js(4.0))))
        finally:
                (var.put('i',Js(var.get('i').to_number())+Js(1))-Js(1))
...
def PyJsHoisted_xor_(byteOne, byteTwo, this, arguments, var=var):
    ...
    while (var.get('i')<var.get('byteOne').get('length')):
        try:
            var.get('xorByte').put(var.get('i'), (var.get('byteOne').get(var.get('i'))^var.get('byteTwo').get(var.get('i'))))
        finally:
                (var.put('i',Js(var.get('i').to_number())+Js(1))-Js(1))
...
def PyJsHoisted_sBoxPermute_(expandByte, this, arguments, var=var):
    ...
    var.registers(['s7', 'j', 's5', 's3', 's8', 'i', 'binary', 'expandByte', 's1', 's4', 's6', 'sBoxByte', 's2'])
    var.put('sBoxByte', var.get('Array').create(Js(32.0)))
    var.put('binary', Js(''))
    var.put('s1', Js([Js([Js(14.0), Js(4.0), Js(13.0), Js(1.0), Js(2.0), Js(15.0), Js(11.0), Js(8.0), Js(3.0), Js(10.0), Js(6.0), Js(12.0), Js(5.0), Js(9.0), Js(0.0), Js(7.0)]), Js([Js(0.0), Js(15.0), Js(7.0), Js(4.0), Js(14.0), Js(2.0), Js(13.0), Js(1.0), Js(10.0), Js(6.0), Js(12.0), Js(11.0), Js(9.0), Js(5.0), Js(3.0), Js(8.0)]), Js([Js(4.0), Js(1.0), Js(14.0), Js(8.0), Js(13.0), Js(6.0), Js(2.0), Js(11.0), Js(15.0), Js(12.0), Js(9.0), Js(7.0), Js(3.0), Js(10.0), Js(5.0), Js(0.0)]), Js([Js(15.0), Js(12.0), Js(8.0), Js(2.0), Js(4.0), Js(9.0), Js(1.0), Js(7.0), Js(5.0), Js(11.0), Js(3.0), Js(14.0), Js(10.0), Js(0.0), Js(6.0), Js(13.0)])]))
    var.put('s2', Js([Js([Js(15.0), Js(1.0), Js(8.0), Js(14.0), Js(6.0), Js(11.0), Js(3.0), Js(4.0), Js(9.0), Js(7.0), Js(2.0), Js(13.0), Js(12.0), Js(0.0), Js(5.0), Js(10.0)]), Js([Js(3.0), Js(13.0), Js(4.0), Js(7.0), Js(15.0), Js(2.0), Js(8.0), Js(14.0), Js(12.0), Js(0.0), Js(1.0), Js(10.0), Js(6.0), Js(9.0), Js(11.0), Js(5.0)]), Js([Js(0.0), Js(14.0), Js(7.0), Js(11.0), Js(10.0), Js(4.0), Js(13.0), Js(1.0), Js(5.0), Js(8.0), Js(12.0), Js(6.0), Js(9.0), Js(3.0), Js(2.0), Js(15.0)]), Js([Js(13.0), Js(8.0), Js(10.0), Js(1.0), Js(3.0), Js(15.0), Js(4.0), Js(2.0), Js(11.0), Js(6.0), Js(7.0), Js(12.0), Js(0.0), Js(5.0), Js(14.0), Js(9.0)])]))
    var.put('s3', Js([Js([Js(10.0), Js(0.0), Js(9.0), Js(14.0), Js(6.0), Js(3.0), Js(15.0), Js(5.0), Js(1.0), Js(13.0), Js(12.0), Js(7.0), Js(11.0), Js(4.0), Js(2.0), Js(8.0)]), Js([Js(13.0), Js(7.0), Js(0.0), Js(9.0), Js(3.0), Js(4.0), Js(6.0), Js(10.0), Js(2.0), Js(8.0), Js(5.0), Js(14.0), Js(12.0), Js(11.0), Js(15.0), Js(1.0)]), Js([Js(13.0), Js(6.0), Js(4.0), Js(9.0), Js(8.0), Js(15.0), Js(3.0), Js(0.0), Js(11.0), Js(1.0), Js(2.0), Js(12.0), Js(5.0), Js(10.0), Js(14.0), Js(7.0)]), Js([Js(1.0), Js(10.0), Js(13.0), Js(0.0), Js(6.0), Js(9.0), Js(8.0), Js(7.0), Js(4.0), Js(15.0), Js(14.0), Js(3.0), Js(11.0), Js(5.0), Js(2.0), Js(12.0)])]))
    var.put('s4', Js([Js([Js(7.0), Js(13.0), Js(14.0), Js(3.0), Js(0.0), Js(6.0), Js(9.0), Js(10.0), Js(1.0), Js(2.0), Js(8.0), Js(5.0), Js(11.0), Js(12.0), Js(4.0), Js(15.0)]), Js([Js(13.0), Js(8.0), Js(11.0), Js(5.0), Js(6.0), Js(15.0), Js(0.0), Js(3.0), Js(4.0), Js(7.0), Js(2.0), Js(12.0), Js(1.0), Js(10.0), Js(14.0), Js(9.0)]), Js([Js(10.0), Js(6.0), Js(9.0), Js(0.0), Js(12.0), Js(11.0), Js(7.0), Js(13.0), Js(15.0), Js(1.0), Js(3.0), Js(14.0), Js(5.0), Js(2.0), Js(8.0), Js(4.0)]), Js([Js(3.0), Js(15.0), Js(0.0), Js(6.0), Js(10.0), Js(1.0), Js(13.0), Js(8.0), Js(9.0), Js(4.0), Js(5.0), Js(11.0), Js(12.0), Js(7.0), Js(2.0), Js(14.0)])]))
    var.put('s5', Js([Js([Js(2.0), Js(12.0), Js(4.0), Js(1.0), Js(7.0), Js(10.0), Js(11.0), Js(6.0), Js(8.0), Js(5.0), Js(3.0), Js(15.0), Js(13.0), Js(0.0), Js(14.0), Js(9.0)]), Js([Js(14.0), Js(11.0), Js(2.0), Js(12.0), Js(4.0), Js(7.0), Js(13.0), Js(1.0), Js(5.0), Js(0.0), Js(15.0), Js(10.0), Js(3.0), Js(9.0), Js(8.0), Js(6.0)]), Js([Js(4.0), Js(2.0), Js(1.0), Js(11.0), Js(10.0), Js(13.0), Js(7.0), Js(8.0), Js(15.0), Js(9.0), Js(12.0), Js(5.0), Js(6.0), Js(3.0), Js(0.0), Js(14.0)]), Js([Js(11.0), Js(8.0), Js(12.0), Js(7.0), Js(1.0), Js(14.0), Js(2.0), Js(13.0), Js(6.0), Js(15.0), Js(0.0), Js(9.0), Js(10.0), Js(4.0), Js(5.0), Js(3.0)])]))
    var.put('s6', Js([Js([Js(12.0), Js(1.0), Js(10.0), Js(15.0), Js(9.0), Js(2.0), Js(6.0), Js(8.0), Js(0.0), Js(13.0), Js(3.0), Js(4.0), Js(14.0), Js(7.0), Js(5.0), Js(11.0)]), Js([Js(10.0), Js(15.0), Js(4.0), Js(2.0), Js(7.0), Js(12.0), Js(9.0), Js(5.0), Js(6.0), Js(1.0), Js(13.0), Js(14.0), Js(0.0), Js(11.0), Js(3.0), Js(8.0)]), Js([Js(9.0), Js(14.0), Js(15.0), Js(5.0), Js(2.0), Js(8.0), Js(12.0), Js(3.0), Js(7.0), Js(0.0), Js(4.0), Js(10.0), Js(1.0), Js(13.0), Js(11.0), Js(6.0)]), Js([Js(4.0), Js(3.0), Js(2.0), Js(12.0), Js(9.0), Js(5.0), Js(15.0), Js(10.0), Js(11.0), Js(14.0), Js(1.0), Js(7.0), Js(6.0), Js(0.0), Js(8.0), Js(13.0)])]))
    var.put('s7', Js([Js([Js(4.0), Js(11.0), Js(2.0), Js(14.0), Js(15.0), Js(0.0), Js(8.0), Js(13.0), Js(3.0), Js(12.0), Js(9.0), Js(7.0), Js(5.0), Js(10.0), Js(6.0), Js(1.0)]), Js([Js(13.0), Js(0.0), Js(11.0), Js(7.0), Js(4.0), Js(9.0), Js(1.0), Js(10.0), Js(14.0), Js(3.0), Js(5.0), Js(12.0), Js(2.0), Js(15.0), Js(8.0), Js(6.0)]), Js([Js(1.0), Js(4.0), Js(11.0), Js(13.0), Js(12.0), Js(3.0), Js(7.0), Js(14.0), Js(10.0), Js(15.0), Js(6.0), Js(8.0), Js(0.0), Js(5.0), Js(9.0), Js(2.0)]), Js([Js(6.0), Js(11.0), Js(13.0), Js(8.0), Js(1.0), Js(4.0), Js(10.0), Js(7.0), Js(9.0), Js(5.0), Js(0.0), Js(15.0), Js(14.0), Js(2.0), Js(3.0), Js(12.0)])]))
    var.put('s8', Js([Js([Js(13.0), Js(2.0), Js(8.0), Js(4.0), Js(6.0), Js(15.0), Js(11.0), Js(1.0), Js(10.0), Js(9.0), Js(3.0), Js(14.0), Js(5.0), Js(0.0), Js(12.0), Js(7.0)]), Js([Js(1.0), Js(15.0), Js(13.0), Js(8.0), Js(10.0), Js(3.0), Js(7.0), Js(4.0), Js(12.0), Js(5.0), Js(6.0), Js(11.0), Js(0.0), Js(14.0), Js(9.0), Js(2.0)]), Js([Js(7.0), Js(11.0), Js(4.0), Js(1.0), Js(9.0), Js(12.0), Js(14.0), Js(2.0), Js(0.0), Js(6.0), Js(10.0), Js(13.0), Js(15.0), Js(3.0), Js(5.0), Js(8.0)]), Js([Js(2.0), Js(1.0), Js(14.0), Js(7.0), Js(4.0), Js(10.0), Js(8.0), Js(13.0), Js(15.0), Js(12.0), Js(9.0), Js(0.0), Js(3.0), Js(5.0), Js(6.0), Js(11.0)])]))
    #for JS loop
    var.put('m', Js(0.0))
    while (var.get('m')<Js(8.0)):
        try:
            var.put('i', Js(0.0))
            var.put('j', Js(0.0))
            var.put('i', ((var.get('expandByte').get(((var.get('m')*Js(6.0))+Js(0.0)))*Js(2.0))+var.get('expandByte').get(((var.get('m')*Js(6.0))+Js(5.0)))))
            var.put('j', ((((((var.get('expandByte').get(((var.get('m')*Js(6.0))+Js(1.0)))*Js(2.0))*Js(2.0))*Js(2.0))+((var.get('expandByte').get(((var.get('m')*Js(6.0))+Js(2.0)))*Js(2.0))*Js(2.0)))+(var.get('expandByte').get(((var.get('m')*Js(6.0))+Js(3.0)))*Js(2.0)))+var.get('expandByte').get(((var.get('m')*Js(6.0))+Js(4.0)))))
            while 1:
                SWITCHED = False
                CONDITION = (var.get('m'))
                ...
                SWITCHED = True
                break
            var.get('sBoxByte').put(((var.get('m')*Js(4.0))+Js(0.0)), var.get('parseInt')(var.get('binary').callprop('substring', Js(0.0), Js(1.0))))
            var.get('sBoxByte').put(((var.get('m')*Js(4.0))+Js(1.0)), var.get('parseInt')(var.get('binary').callprop('substring', Js(1.0), Js(2.0))))
            var.get('sBoxByte').put(((var.get('m')*Js(4.0))+Js(2.0)), var.get('parseInt')(var.get('binary').callprop('substring', Js(2.0), Js(3.0))))
            var.get('sBoxByte').put(((var.get('m')*Js(4.0))+Js(3.0)), var.get('parseInt')(var.get('binary').callprop('substring', Js(3.0), Js(4.0))))
        finally:
                (var.put('m',Js(var.get('m').to_number())+Js(1))-Js(1))
...
def PyJsHoisted_pPermute_(sBoxByte, this, arguments, var=var):
    ...
    var.registers(['sBoxByte', 'pBoxPermute'])
...
def PyJsHoisted_generateKeys_(keyByte, this, arguments, var=var):
    ...
    var.registers(['keys', 'tempRight', 'key', 'i', 'keyByte', 'tempKey', 'tempLeft', 'loop'])
    ...
    var.put('loop', Js([Js(1.0), Js(1.0), Js(2.0), Js(2.0), Js(2.0), Js(2.0), Js(2.0), Js(2.0), Js(1.0), Js(2.0), Js(2.0), Js(2.0), Js(2.0), Js(2.0), Js(2.0), Js(1.0)]))
    #for JS loop
    var.put('i', Js(0.0))
    while (var.get('i')<Js(7.0)):
        try:
            ...
            while (var.get('j')<Js(8.0)):
                try:
                    var.get('key').put(((var.get('i')*Js(8.0))+var.get('j')), var.get('keyByte').get(((Js(8.0)*var.get('k'))+var.get('i'))))
                finally:
                        PyJsComma((var.put('j',Js(var.get('j').to_number())+Js(1))-Js(1)),(var.put('k',Js(var.get('k').to_number())-Js(1))+Js(1)))
        finally:
                (var.put('i',Js(var.get('i').to_number())+Js(1))-Js(1))
